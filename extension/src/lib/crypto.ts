...
export async function aesGcmEncrypt(plaintext: string, pin: string): Promise<string> {
...
export async function aesGcmDecrypt(blobB64: string, pin: string): Promise<string> {
